...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-remark/security/advisories/new>
...
- Keep `eslint-plugin-remark`, ESLint, TypeScript, and dependencies updated.
